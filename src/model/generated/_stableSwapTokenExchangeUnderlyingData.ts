...
export class StableSwapTokenExchangeUnderlyingData {
    public readonly isTypeOf = 'StableSwapTokenExchangeUnderlyingData'
    ...
    constructor(props?: Partial<Omit<StableSwapTokenExchangeUnderlyingData, 'toJSON'>>, json?: any) {
